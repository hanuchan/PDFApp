 ...
 */
public class ThumbnailViews extends AdapterView<ListAdapter> implements
	...
	public interface OnScrollListener {
		 ...
		 *            {@link #SCROLL_STATE_IDLE}.
		 */
		public void onScrollStateChanged(ThumbnailViews view, int scrollState);
		 ...
		 */
		public void onScroll(ThumbnailViews view, int firstVisibleItem,
	 ...
	 * 
	 * @see ThumbnailViews.RecycleBin
	 * @see ThumbnailViews#setRecyclerListener(ThumbnailViews.RecyclerListener)
	 */
	...
	public ThumbnailViews(Context context) {
		this(context, null);
	}

	public ThumbnailViews(Context context, AttributeSet attrs) {
	 ...
	 * 
	 * @see ThumbnailViews.RecycleBin
	 * @see ThumbnailViews.RecyclerListener
	 */
	...
	public boolean showContextMenuForChild(View originalView) {
		...
		if (longPressPosition >= 0) {
			...
			if (listener != null) {
				handled = listener.onItemLongClick(ThumbnailViews.this,
	...
	public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
		...
		event.setClassName(ThumbnailViews.class.getName());
	}
	...
	private boolean performLongPress(final View child,
		...
		OnItemLongClickListener listener = getOnItemLongClickListener();
		if (listener != null) {
			handled = listener.onItemLongClick(ThumbnailViews.this, child,
					longPressPosition, longPressId);
		}
	...
	private class AdapterDataSetObserver extends DataSetObserver {
		...
		public void onChanged() {
			...
			if (ThumbnailViews.this.mHasStableIds && mInstanceState != null
					&& mOldItemCount == 0 && mItemCount > 0) {
				ThumbnailViews.this.onRestoreInstanceState(mInstanceState);
				mInstanceState = null;
			} else {
				rememberSyncState();
			}
		...
		public void onInvalidated() {
			...
			if (ThumbnailViews.this.mHasStableIds) {
				// Remember the current state for the case where our hosting
				// activity is being
				// stopped and later restarted
				mInstanceState = ThumbnailViews.this.onSaveInstanceState();
			}
	...
	static class SavedState extends BaseSavedState {
		...
		/**
		 * Constructor called from {@link ThumbnailViews#onSaveInstanceState()}
		 */
	...
	private static class ArrowScrollFocusResult {
		...
		/**
		 * How {@link ThumbnailViews#arrowScrollFocused} returns its values.
		 */
