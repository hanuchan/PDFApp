...
public class ReaderView extends AdapterView<Adapter>
	...
	private final GestureDetector
				  mGestureDetector;
	public final ScaleGestureDetector
	...
	public void updateViewZoom( ScaleGestureDetector detector )
	{
		mScaling = true;
		...
		//if( DocumentReaderView.s_Instant.getVisibility() == INVISIBLE)
		{
